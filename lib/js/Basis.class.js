...
(function(global,namespace,factory,undefined){
	...
	if(!Array.prototype.merge){
		Array.method('merge',function(arr){
			if(this.concat){
...
window[LHH_NAMESPACE_20150715_].main([window,LHH_CLASSPATH_20150717_.getClassPath()],function(W,classPath){
	'use strict';
	var System=this;
