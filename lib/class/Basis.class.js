...
(function(global,namespace,factory,undefined){
	...
	MySystem={
		...
		'use':function(){
			...
			this.Config.render.default.script.Attribute.async=true;
			return this;
		},
		/**
		 * @author: lhh
		...
		'unuse':function(){
			...
			this.Config.render.default.script.Attribute.async=false;
			return this;
		},
		 ...
		 */
		'print':function(){
			var i,arg=arguments,len=arguments.length,arr=[];
			for(i=0;i<len;i++){
				arr.push(arg[i]);
			}
