...
window[LHH_NAMESPACE_20150715_].main([window,LHH_CONFIG_20150717_],function(W,Config){
	...
	var create       = Config.render.create;
	var sAttribute   = Config.render.script.Attribute;
	var cAttribute   = Config.render.css.Attribute;
