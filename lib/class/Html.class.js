...
window[LHH_NAMESPACE_20150715_].main([window],function(window,undefined){
	 ...
	 * @param 	(String)type             NO NULL :获取方式
	 * @param 	(String)dataType         NO NULL :获取文件类型
	 ...
	 *
	 */
	function getFile($dom,D,type,dataType,async,cache,callBack){
		type  		= D&&D.type  || $dom.attr('dataType') || "GET";
