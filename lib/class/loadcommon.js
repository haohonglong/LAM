                ...
                for (i=0,len=D.js.length;i<len;i++){
                    ...
                    if(System.isString(js)){
                        ...
                        if(System.classes.indexOf(js) != -1 || System.files.indexOf(src) != -1){
                            ...
                            A['src'] = src;
                            if('create' === create){
                                var script=dom.create('script',A);
                                if(0 === i){
                                    dom.insertBefore(script.node,head.firstChild);
                                }else{
                                    dom.insertAfter(s[i-1],script.node);
                                }
                            }else{
                                files.push(System.Basis.printScript(A));
                            }
                        ...
                        if(System.classes.indexOf(js.src) != -1 || System.files.indexOf(js.src) != -1){
                            ...
                            System.merge(js,[sAttribute],true);
                            if('create' === create){
                                var script=dom.create('script',js);
                                if(0 === i){
                                    dom.insertBefore(script.node,head.firstChild);
                                }else{
                                    dom.insertAfter(s[i-1],script.node);
            ...
            if(D.css){
                ...
                for (i=0,len=D.css.length;i<len;i++){
                    ...
                    if(System.isString(css)){
                        ...
                        A['href'] = href;
                        if('create' === create){
                            var css=dom.create('link',A);
                            if(0 === i){
                                dom.insertAfter(s[s.length-1],css.node);
                            }else{
                                dom.insertAfter(l[i-1],css.node);
                            }
                        }else{
                            files.push(System.Basis.printLink(A));
                        }
                        ...
                        System.merge(css,[cAttribute],true);
                        if('create' === create){
                            var css=dom.create('link',css);
                            if(0 === i){
                                dom.insertAfter(s[s.length-1],css.node);
                            }else{
                                dom.insertAfter(l[i-1],css.node);
