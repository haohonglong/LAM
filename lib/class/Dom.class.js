window[LHH_NAMESPACE_20150715_].main([window],function(window,undefined){
	...
	Dom.prototype = {
		...
		'innerHTML':function(html,tag) {
			...
			for (var documentFragment = document.createDocumentFragment(); this.node.firstChild; ) {
				documentFragment.appendChild(this.node.firstChild);
			}
			return documentFragment.childNodes.length > 1 ? documentFragment : documentFragment.removeChild(documentFragment.firstChild);
		},
