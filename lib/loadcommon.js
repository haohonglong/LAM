            ...
            if(D.js){
                ...
                for (i=0,len=D.js.length;i<len;i++){
                    ...
                    if(System.isString(js)){
                        if(!this.classisexist(js)){
                            if(System.classes.indexOf(js) != -1){
                                continue;
                            }else{
                                if(baseUrl){
                                    files.push(System.Basis.printScript({'src':baseUrl+js+suffix}));
                                }else{
                                    files.push(System.Basis.printScript({'src':js+suffix}));
                                }
                        ...
                        if(!this.classisexist(js.src)){
                            if(System.classes.indexOf(js.src) != -1){
                                continue;
                            }else{

                                if(baseUrl){
                                    js.src=baseUrl+js.src+suffix;
                                    files.push(System.Basis.printScript(js));
                                }else{
                                    js.src=js.src+suffix;
                                    files.push(System.Basis.printScript(js));
                                }
                                System.classes.push(js);
                            }
            ...
            if(D.css){
                ...
                for (i=0,len=D.css.length;i<len;i++){
                    ...
                    if(System.isString(css)){
                        if(baseUrl){
                            files.push(System.Basis.printLink({'href':baseUrl+css+suffix,'rel':rel}));
                        }else{
                            files.push(System.Basis.printLink({'href':css+suffix,'rel':rel}));
                        }
                    }else if(System.isObject(css)){
                        css.rel = css.rel || rel;
                        if(baseUrl){
                            css.href=baseUrl+css.href+suffix;
                            files.push(System.Basis.printLink(css));
                        }else{
                            css.href=css.href+suffix;
                            files.push(System.Basis.printLink(css));
                        }
                    }
